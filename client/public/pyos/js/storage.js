...
const PyStorage = (() => {
  ...
  function bootstrap() {
    ...
    ensureDir("system/runtime");
    ensureDir("system/security");
    ensureDir("system/tmp");
    ...
    ensureDir("Users");
    ensureDir("Users/Public");
    ensureDir("Users/Default");
    ...
    ensureFile("system/config/paths.cfg", "[paths]\nprogram_files=Program Files\nprogram_files_x86=Program Files (x86)\napp_data=AppData\nhome=home\n");
    ensureFile("system/config/version.cfg", "[release]\nname=PyOS Web PC Edition\nchannel=stable\narchitecture=browser-desktop\n");
